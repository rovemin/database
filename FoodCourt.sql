...
-- [인덱스 생성]
CREATE INDEX CTYPENO_IDX ON CORNER(CTYPENO);

CREATE INDEX SEX_IDX ON USER_INFO(SEX);

CREATE INDEX DAY_IDX ON ORDER_INFO(DAY);

CREATE INDEX PACK_IDX ON ORDER_INFO(PACK, CPHONE);

CREATE INDEX REVIEW_IDX ON REVIEW(RESCORE, RECONTENT);
